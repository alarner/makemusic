...
<hr class="space">
<!-- ****COMMENTED OUT REGISTER. REGISTRATION CLOSED**** -->
<!--
<table>
	<thead>
		<tr>
	...
	<tbody>
		<tr>
			<td>
				<strong>Want to take part in Make Music New York?<br><a href="<?php echo $this->webroot;?>users/register/">Register now to participate</a></strong>
			</td>
		</tr>
	</tbody>
</table>
...
<table>
	...
	<tbody>
		<tr>
			<td>
				<strong>Get Make Music New York updates.<br><a href="<?php echo $this->webroot;?>users/subscribe">Subscribe to the MMNY Newsletter</a></strong>
			</td>
		</tr>
	</tbody>
</table>
...
<table>
	...
	<tbody>
		<tr>
			<td>
				<a href="http://www.makemusicny.org/" >Visit the MMNY official site</a></strong>
				<hr class="space">
				<a href="http://newyork.timeout.com/section/music" >Find out about this week's top live shows</a></strong>
			</td>
		</tr>
	</tbody>
</table>